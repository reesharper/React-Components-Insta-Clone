...
- [ ]  To complete this projearch Bar beinect there will be a single instance of the Sg rendered at the top of the page, as well as a Posts component that renders an individual Post for every object inside the `dummy-data.js` array.
